      ...
      <div className="container mx-auto mt-8">
        <div className="flex justify-center item-center gap-10">
          ...
          <div className="max-w-md bg-white shadow-md rounded-md overflow-hidden mr-4">
            <img src="src/assets/image 4.png" alt="Placeholder" className="w-full h-64 object-cover" />
            <div className="p-4">
          ...
          <div className="max-w-md bg-white shadow-md rounded-md overflow-hidden">
            <img src="src/assets/image 5.png" alt="Placeholder" className="w-full h-64 object-cover" />
            <div className="p-4">
