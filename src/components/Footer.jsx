    ...
    <footer
      ...
      <div
        ...
        <div className="flex justify-center">
          <a href="www.google.com" className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* <!-- TW Elements section --> */}
          <div className="">
          <img src={logo} alt="Logo" className="h-16 mr-4" style={{ filter: "invert(100%)" }} />
            <h6
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
        ...
        <a
          ...
          href="https://instagram.com/pankaj.ra1/"
        >Pankaj Rai</a>
      </div>
    </footer>
  );
