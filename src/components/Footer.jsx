...
import logo from "/src/assets/logo.png"; // Ensure this path is correct according to your project structure

export default function App() {
  return (
    <footer className="bg-blue-400 text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 w-full flex justify-between items-center p-4">
      {/* Left side: Copyright text */}
      <div className="text-black font-[500] dark:text-neutral-200">
        © 2024 Copyright: <a className="font-semibold dark:text-neutral-400" href="https://www.cyberpeace.org/">CyberPeace Foundation</a>
      </div>
      ...
      <div className="flex items-center">
        ...
        {/* LinkedIn link */}
        <a href="https://in.linkedin.com/company/cyberpeacefoundation" className="text-black dark:text-neutral-200">
          {/* LinkedIn SVG icon */}
